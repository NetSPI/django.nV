...
urlpatterns = patterns('',
	...
	url(r'^downloadprofilepic/(?P<user_id>\d+)/$', views.downloadprofilepic, name = 'download_profile_pic'),
	...
	url(r'^(?P<project_id>\d+)/(?P<task_id>\d+)/editnote/(?P<note_id>\d+)$', views.editNote, name = 'edit_note'),
	url(r'^(?P<project_id>\d+)/(?P<task_id>\d+)/deletenote/(?P<note_id>\d+)$', views.deleteNote, name = 'delete_note'),
	url(r'^register/$', views.register, name = 'register'),
	url(r'^login/$', views.login_view, name = 'login'),
	url(r'^newproject/$', views.newProject, name= 'new_project'),
	url(r'^(?P<project_id>\d+)/edit_project/$', views.editProject, name = 'edit_project'),
